...
define(
    ...
    function ($,
        ...
        return Component.extend({
            defaults: {
                template: 'LizardMedia_PayLane/payment/paypal',
                code: 'paylane_paypal'
            },
            ...
            showPaymentMethodImg: function () {
                return window.checkoutConfig.payment.paylane_paypal.show_img;
            },

            getPaymentMethodImgUrl: function () {
                return window.paylaneImgPath + '/payment_methods/paypal.png';
            },
